...
<head>
    ...
    <title>Самурайский кодекс</title>
    <style>
        body {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        <h1 class="title">武士道 - Кодекс Самурая</h1>
        <div class="content-wrapper">
            ...
            <div class="gif-container">
                <img src="https://i.gifer.com/3QAb.gif" alt="Анимированный самурай" class="samurai-image">
            </div>
            <div class="kanji-column">
                <div class="kanji">道</div>
                <div class="kanji">技</div>
                <div class="kanji">美</div>
                <div class="kanji">コード</div>
            </div>
        </div>
        <div class="footer">
            <p>Сила, честь и дисциплина — путь воина</p>
        </div>
    </div>
</body>
</html>
